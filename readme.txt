...
* Add a CSS file in your theme's directory and place your custom CSS there. The name of the file should be login-THEME.css. For example, `login-default.css` or `login-osx.css`.
